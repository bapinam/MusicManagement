...
namespace MusicManagement.Migrations
{
    ...
    [Migration("20211117052743_Create_MusicEntites")]
    partial class Create_MusicEntites
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicManagement.Albums.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Abp.Albums");
                });

            modelBuilder.Entity("MusicManagement.AuthorSongs.AuthorSong", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Abp.AuthorSongs");
                });

            modelBuilder.Entity("MusicManagement.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MusicManagement.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Abp.Categorys");
                });

            modelBuilder.Entity("MusicManagement.SingerSongs.SingerSong", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Abp.SingerSongs");
                });

            modelBuilder.Entity("MusicManagement.Singers.Singer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Abp.Singers");
                });

            modelBuilder.Entity("MusicManagement.Songs.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MusicManagement.AuthorSongs.AuthorSong", b =>
                {
                    b.HasOne("MusicManagement.Authors.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicManagement.Songs.Song", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicManagement.SingerSongs.SingerSong", b =>
                {
                    b.HasOne("MusicManagement.Singers.Singer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicManagement.Songs.Song", b =>
                {
                    b.HasOne("MusicManagement.Albums.Album", null)
                        .WithMany()
                        .HasForeignKey("AlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicManagement.Categories.Category", null)
                        .WithMany()
