...
{
    public partial class Create_MusicEntites : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Albums", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.Albums_AbpUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Abp.Authors_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Categorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.Categorys_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Singers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.Singers_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Songs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.Songs_Abp.Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Abp.Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.Songs_Abp.Categorys_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Abp.Categorys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.Songs_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.AuthorSongs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.AuthorSongs_Abp.Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Abp.Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.AuthorSongs_Abp.Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Abp.Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.SingerSongs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abp.SingerSongs_Abp.Singers_SingerId",
                        column: x => x.SingerId,
                        principalTable: "Abp.Singers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.SingerSongs_Abp.Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Abp.Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Abp.Albums_CreatorId",
                table: "Abp.Albums",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Authors_CreatorId",
                table: "Abp.Authors",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.AuthorSongs_AuthorId",
                table: "Abp.AuthorSongs",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.AuthorSongs_SongId",
                table: "Abp.AuthorSongs",
                column: "SongId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Categorys_CreatorId",
                table: "Abp.Categorys",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Singers_CreatorId",
                table: "Abp.Singers",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.SingerSongs_SingerId",
                table: "Abp.SingerSongs",
                column: "SingerId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.SingerSongs_SongId",
                table: "Abp.SingerSongs",
                column: "SongId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Songs_AlbumId",
                table: "Abp.Songs",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Songs_CategoryId",
                table: "Abp.Songs",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Abp.Songs_CreatorId",
                table: "Abp.Songs",
                column: "CreatorId");
