...
{
    public class MusicManagementDatabaseCheck : IHealthCheck, ITransientDependency
    {
        protected readonly IIdentityRoleRepository IdentityRoleRepository;

        public MusicManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
        {
